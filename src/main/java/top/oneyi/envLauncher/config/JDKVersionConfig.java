...
public class JdkVersionConfig {
    ...
    static {
        VERSION_TO_ARTIFACT_PATH.put("8", "8/jdk/x64/windows/OpenJDK8U-jdk_x64_windows_hotspot_8u482b08.zip");
        VERSION_TO_ARTIFACT_PATH.put("11", "11/jdk/x64/windows/OpenJDK11U-jdk_x64_windows_hotspot_11.0.30_7.zip");
        VERSION_TO_ARTIFACT_PATH.put("17", "17/jdk/x64/windows/OpenJDK17U-jdk_x64_windows_hotspot_17.0.18_8.zip");
        VERSION_TO_ARTIFACT_PATH.put("21", "21/jdk/x64/windows/OpenJDK21U-jdk_x64_windows_hotspot_21.0.10_7.zip");
    }
